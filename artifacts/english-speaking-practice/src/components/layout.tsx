        ...
        <div className="fixed inset-0 z-50">
          ...
          <aside className="relative flex h-full w-[min(21rem,88vw)] flex-col border-r border-border bg-card p-5 shadow-2xl">
            ...
            <div className="mt-auto space-y-3 border-t border-border pt-5">
              ...
              {!isPremium && <Link href="/pricing" onClick={close} className="flex items-center justify-center gap-2 rounded-2xl bg-accent px-4 py-3.5 text-base font-bold text-accent-foreground shadow-sm"><Sparkles size={18} /> Start Free 2-Day Trial</Link>}
